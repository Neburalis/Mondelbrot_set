...
0000000000001290 <main>:
    ...
    1404:	c5 f9 6f 4c 24 40    	vmovdqa 0x40(%rsp),%xmm1
    140a:	c5 f8 77             	vzeroupper 
    140d:	e8 1e 08 00 00       	call   1c30 <render_frame>
    ...
    144f:	00 
    1450:	0f 85 4e 01 00 00    	jne    15a4 <main+0x314>
    ...
    147c:	eb 28                	jmp    14a6 <main+0x216>
    147e:	bf 07 01 00 00       	mov    $0x107,%edi
    1483:	e8 e8 fc ff ff       	call   1170 <IsKeyDown@plt>
    1488:	c5 fa 10 44 24 20    	vmovss 0x20(%rsp),%xmm0
    148e:	84 c0                	test   %al,%al
    1490:	75 04                	jne    1496 <main+0x206>
    1492:	c5 f8 57 c0          	vxorps %xmm0,%xmm0,%xmm0
    1496:	c5 f8 28 4c 24 30    	vmovaps 0x30(%rsp),%xmm1
    149c:	c5 f2 5c c8          	vsubss %xmm0,%xmm1,%xmm1
    14a0:	c5 f8 29 4c 24 30    	vmovaps %xmm1,0x30(%rsp)
    14a6:	bf 08 01 00 00       	mov    $0x108,%edi
    14ab:	e8 c0 fc ff ff       	call   1170 <IsKeyDown@plt>
    14b0:	84 c0                	test   %al,%al
    14b2:	74 0e                	je     14c2 <main+0x232>
    14b4:	c5 f8 28 44 24 40    	vmovaps 0x40(%rsp),%xmm0
    14ba:	c5 fa 58 44 24 20    	vaddss 0x20(%rsp),%xmm0,%xmm0
    14c0:	eb 22                	jmp    14e4 <main+0x254>
    14c2:	bf 09 01 00 00       	mov    $0x109,%edi
    14c7:	e8 a4 fc ff ff       	call   1170 <IsKeyDown@plt>
    14cc:	84 c0                	test   %al,%al
    14ce:	c5 fa 10 4c 24 20    	vmovss 0x20(%rsp),%xmm1
    14d4:	75 04                	jne    14da <main+0x24a>
    14d6:	c5 f0 57 c9          	vxorps %xmm1,%xmm1,%xmm1
    14da:	c5 f8 28 44 24 40    	vmovaps 0x40(%rsp),%xmm0
    14e0:	c5 fa 5c c1          	vsubss %xmm1,%xmm0,%xmm0
    14e4:	c5 f8 29 44 24 40    	vmovaps %xmm0,0x40(%rsp)
    14ea:	bf 3d 00 00 00       	mov    $0x3d,%edi
    14ef:	e8 7c fc ff ff       	call   1170 <IsKeyDown@plt>
    14f4:	84 c0                	test   %al,%al
    14f6:	74 37                	je     152f <main+0x29f>
    14f8:	c5 f8 28 54 24 60    	vmovaps 0x60(%rsp),%xmm2
    14fe:	c4 e2 79 18 c2       	vbroadcastss %xmm2,%xmm0
    1503:	c5 f8 28 4c 24 30    	vmovaps 0x30(%rsp),%xmm1
    1509:	c4 e3 71 21 4c 24 40 	vinsertps $0x10,0x40(%rsp),%xmm1,%xmm1
    1510:	10 
    1511:	c5 f8 59 05 07 0b 00 	vmulps 0xb07(%rip),%xmm0,%xmm0        # 2020 <_IO_stdin_used+0x20>
    1518:	00 
    1519:	c5 f8 58 c1          	vaddps %xmm1,%xmm0,%xmm0
    151d:	c5 ea 5a ca          	vcvtss2sd %xmm2,%xmm2,%xmm1
    1521:	c5 f3 59 15 8f 0b 00 	vmulsd 0xb8f(%rip),%xmm1,%xmm2        # 20b8 <_IO_stdin_used+0xb8>
    1528:	00 
    1529:	c5 eb 58 c9          	vaddsd %xmm1,%xmm2,%xmm1
    152d:	eb 43                	jmp    1572 <main+0x2e2>
    152f:	bf 2d 00 00 00       	mov    $0x2d,%edi
    1534:	e8 37 fc ff ff       	call   1170 <IsKeyDown@plt>
    1539:	84 c0                	test   %al,%al
    153b:	74 67                	je     15a4 <main+0x314>
    153d:	c5 f8 28 54 24 60    	vmovaps 0x60(%rsp),%xmm2
    1543:	c4 e2 79 18 c2       	vbroadcastss %xmm2,%xmm0
    1548:	c5 f8 28 4c 24 30    	vmovaps 0x30(%rsp),%xmm1
    154e:	c4 e3 71 21 4c 24 40 	vinsertps $0x10,0x40(%rsp),%xmm1,%xmm1
    1555:	10 
    1556:	c5 f8 59 05 c2 0a 00 	vmulps 0xac2(%rip),%xmm0,%xmm0        # 2020 <_IO_stdin_used+0x20>
    155d:	00 
    155e:	c5 f8 58 c1          	vaddps %xmm1,%xmm0,%xmm0
    1562:	c5 ea 5a ca          	vcvtss2sd %xmm2,%xmm2,%xmm1
    1566:	c5 f3 59 15 42 0b 00 	vmulsd 0xb42(%rip),%xmm1,%xmm2        # 20b0 <_IO_stdin_used+0xb0>
    156d:	00 
    156e:	c5 f3 58 ca          	vaddsd %xmm2,%xmm1,%xmm1
    1572:	c5 f3 5a d1          	vcvtsd2ss %xmm1,%xmm1,%xmm2
    1576:	c5 ea 59 0d f2 0a 00 	vmulss 0xaf2(%rip),%xmm2,%xmm1        # 2070 <_IO_stdin_used+0x70>
    157d:	00 
    157e:	c5 f2 58 c8          	vaddss %xmm0,%xmm1,%xmm1
    1582:	c5 f8 29 4c 24 30    	vmovaps %xmm1,0x30(%rsp)
    1588:	c5 fa 16 c0          	vmovshdup %xmm0,%xmm0
    158c:	c5 f8 29 54 24 60    	vmovaps %xmm2,0x60(%rsp)
    1592:	c5 ea 59 0d da 0a 00 	vmulss 0xada(%rip),%xmm2,%xmm1        # 2074 <_IO_stdin_used+0x74>
    1599:	00 
    159a:	c5 f2 58 c0          	vaddss %xmm0,%xmm1,%xmm0
    159e:	c5 f8 29 44 24 40    	vmovaps %xmm0,0x40(%rsp)
    15a4:	c5 f8 28 4c 24 60    	vmovaps 0x60(%rsp),%xmm1
    15aa:	c5 f8 28 54 24 30    	vmovaps 0x30(%rsp),%xmm2
    15b0:	c5 ea 58 c1          	vaddss %xmm1,%xmm2,%xmm0
    15b4:	c4 e2 7d 18 d9       	vbroadcastss %xmm1,%ymm3
    15b9:	c5 e0 59 0d 6f 0a 00 	vmulps 0xa6f(%rip),%xmm3,%xmm1        # 2030 <_IO_stdin_used+0x30>
    15c0:	00 
    15c1:	c4 e2 79 18 d2       	vbroadcastss %xmm2,%xmm2
    15c6:	c5 f0 58 ca          	vaddps %xmm2,%xmm1,%xmm1
    15ca:	c5 fc 29 9c 24 e0 01 	vmovaps %ymm3,0x1e0(%rsp)
    15d1:	00 00 
    15d3:	c5 e0 59 1d 65 0a 00 	vmulps 0xa65(%rip),%xmm3,%xmm3        # 2040 <_IO_stdin_used+0x40>
    15da:	00 
    15db:	c5 e0 58 da          	vaddps %xmm2,%xmm3,%xmm3
    15df:	c4 e3 69 21 c0 10    	vinsertps $0x10,%xmm0,%xmm2,%xmm0
    15e5:	c4 e3 fd 01 c9 d0    	vpermpd $0xd0,%ymm1,%ymm1
    15eb:	c4 e3 75 0c c0 03    	vblendps $0x3,%ymm0,%ymm1,%ymm0
    15f1:	c4 e3 75 18 cb 01    	vinsertf128 $0x1,%xmm3,%ymm1,%ymm1
    15f7:	c5 fd c6 c1 02       	vshufpd $0x2,%ymm1,%ymm0,%ymm0
    15fc:	c5 fd 29 84 24 c0 01 	vmovapd %ymm0,0x1c0(%rsp)
    1603:	00 00 
    1605:	45 31 e4             	xor    %r12d,%r12d
    1608:	c5 fa 10 1d 68 0a 00 	vmovss 0xa68(%rip),%xmm3        # 2078 <_IO_stdin_used+0x78>
    160f:	00 
    1610:	eb 26                	jmp    1638 <main+0x3a8>
    ...
    1a53:	00 00 
    1a55:	c5 f9 6f 4c 24 20    	vmovdqa 0x20(%rsp),%xmm1
    1a5b:	c5 f9 7e 8c 24 bc 00 	vmovd  %xmm1,0xbc(%rsp)
    1a62:	00 00 
    ...
    1a80:	b9 00 00 00 ff       	mov    $0xff000000,%ecx
    1a85:	3d 00 01 00 00       	cmp    $0x100,%eax
    1a8a:	0f 84 7b 01 00 00    	je     1c0b <main+0x97b>
    ...
    1c25:	e9 56 fe ff ff       	jmp    1a80 <main+0x7f0>
    1c2a:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)

0000000000001c30 <render_frame>:
    1c30:	55                   	push   %rbp
    1c31:	48 89 e5             	mov    %rsp,%rbp
    1c34:	41 56                	push   %r14
    1c36:	53                   	push   %rbx
    1c37:	48 81 ec 90 00 00 00 	sub    $0x90,%rsp
    1c3e:	80 3d 94 24 00 00 00 	cmpb   $0x0,0x2494(%rip)        # 40d9 <disable_window>
    1c45:	0f 85 fb 00 00 00    	jne    1d46 <render_frame+0x116>
    1c4b:	41 89 f6             	mov    %esi,%r14d
    1c4e:	48 8d 5d 10          	lea    0x10(%rbp),%rbx
    1c52:	8b 43 10             	mov    0x10(%rbx),%eax
    1c55:	89 44 24 10          	mov    %eax,0x10(%rsp)
    1c59:	c5 fa 11 45 e8       	vmovss %xmm0,-0x18(%rbp)
    1c5e:	c5 f8 10 03          	vmovups (%rbx),%xmm0
    1c62:	c5 f8 11 04 24       	vmovups %xmm0,(%rsp)
    1c67:	c5 fa 11 4d ec       	vmovss %xmm1,-0x14(%rbp)
    1c6c:	e8 4f f4 ff ff       	call   10c0 <UpdateTexture@plt>
    1c71:	e8 ea f3 ff ff       	call   1060 <BeginDrawing@plt>
    1c76:	bf f5 f5 f5 ff       	mov    $0xfff5f5f5,%edi
    1c7b:	e8 50 f4 ff ff       	call   10d0 <ClearBackground@plt>
    1c80:	8b 43 10             	mov    0x10(%rbx),%eax
    1c83:	89 44 24 10          	mov    %eax,0x10(%rsp)
    1c87:	c5 f8 10 03          	vmovups (%rbx),%xmm0
    1c8b:	c5 f8 11 04 24       	vmovups %xmm0,(%rsp)
    1c90:	31 ff                	xor    %edi,%edi
    1c92:	31 f6                	xor    %esi,%esi
    1c94:	ba ff ff ff ff       	mov    $0xffffffff,%edx
    1c99:	e8 72 f4 ff ff       	call   1110 <DrawTexture@plt>
    1c9e:	bf 0a 00 00 00       	mov    $0xa,%edi
    1ca3:	be 0a 00 00 00       	mov    $0xa,%esi
    1ca8:	e8 f3 f3 ff ff       	call   10a0 <DrawFPS@plt>
    1cad:	c5 fa 10 45 e8       	vmovss -0x18(%rbp),%xmm0
    1cb2:	c5 fa 5a c0          	vcvtss2sd %xmm0,%xmm0,%xmm0
    1cb6:	c5 fa 10 4d ec       	vmovss -0x14(%rbp),%xmm1
    1cbb:	c5 f2 5a c9          	vcvtss2sd %xmm1,%xmm1,%xmm1
    1cbf:	48 8d 15 32 04 00 00 	lea    0x432(%rip),%rdx        # 20f8 <_IO_stdin_used+0xf8>
    1cc6:	48 8d 5d c0          	lea    -0x40(%rbp),%rbx
    1cca:	be 20 00 00 00       	mov    $0x20,%esi
    1ccf:	48 89 df             	mov    %rbx,%rdi
    1cd2:	b0 02                	mov    $0x2,%al
    1cd4:	e8 57 f3 ff ff       	call   1030 <snprintf@plt>
    1cd9:	48 89 df             	mov    %rbx,%rdi
    1cdc:	be 0a 00 00 00       	mov    $0xa,%esi
    1ce1:	ba 1e 00 00 00       	mov    $0x1e,%edx
    1ce6:	b9 10 00 00 00       	mov    $0x10,%ecx
    1ceb:	41 b8 00 e4 30 ff    	mov    $0xff30e400,%r8d
    1cf1:	e8 4a f3 ff ff       	call   1040 <DrawText@plt>
    1cf6:	e8 85 f4 ff ff       	call   1180 <GetFrameTime@plt>
    1cfb:	c5 fa 59 05 a5 03 00 	vmulss 0x3a5(%rip),%xmm0,%xmm0        # 20a8 <_IO_stdin_used+0xa8>
    1d02:	00 
    1d03:	c5 fa 5a c0          	vcvtss2sd %xmm0,%xmm0,%xmm0
    1d07:	48 8d 15 fb 03 00 00 	lea    0x3fb(%rip),%rdx        # 2109 <_IO_stdin_used+0x109>
    1d0e:	48 8d 5d 80          	lea    -0x80(%rbp),%rbx
    1d12:	be 40 00 00 00       	mov    $0x40,%esi
    1d17:	48 89 df             	mov    %rbx,%rdi
    1d1a:	44 89 f1             	mov    %r14d,%ecx
    1d1d:	b0 01                	mov    $0x1,%al
    1d1f:	e8 0c f3 ff ff       	call   1030 <snprintf@plt>
    1d24:	48 89 df             	mov    %rbx,%rdi
    1d27:	be 0a 00 00 00       	mov    $0xa,%esi
    1d2c:	ba 2d 00 00 00       	mov    $0x2d,%edx
    1d31:	b9 10 00 00 00       	mov    $0x10,%ecx
    1d36:	41 b8 00 79 f1 ff    	mov    $0xfff17900,%r8d
    1d3c:	e8 ff f2 ff ff       	call   1040 <DrawText@plt>
    1d41:	e8 0a f3 ff ff       	call   1050 <EndDrawing@plt>
    1d46:	48 81 c4 90 00 00 00 	add    $0x90,%rsp
    1d4d:	5b                   	pop    %rbx
    1d4e:	41 5e                	pop    %r14
    1d50:	5d                   	pop    %rbp
    1d51:	c3                   	ret    
